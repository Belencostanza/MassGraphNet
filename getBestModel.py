...
from load_data_symmetries import training_set, validation_set, test_set, n_CPU, study_name
from network_NF_Added import GNN, batch_size, name_model
...
def eval(dist_x2_given_x1, model, valid_loader = None):
  ...
  for data in valid_loader:
    with torch.no_grad():
        ...
        # This is for extra analysis for property and error bar dependence
        pointer = 0
