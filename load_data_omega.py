...
#name of the dataset 
name_train = 'omega_train.pt'
name_valid = 'omega_valid.pt'
name_test = 'omega_test.pt'
...
def create_graphs_new(halolist, tab, GroupPos, GroupVel, omega, parameters):
    ...
    for ind in halolist: 
        ...
        if n_sub > 10: 
            ...
            if global_parameters == True:
                ...
                u = np.concatenate((u_number, u_parameters), axis=0)
            else:
                u = u_number
                
            mass = torch.tensor(omega, dtype=torch.float32) #target
...
def training_set():
    ...
    for i in range(0,split_train):
        ...
        data_sim = create_graphs_new(halolist, tab, GroupPos, GroupVel, omega, parameters)
